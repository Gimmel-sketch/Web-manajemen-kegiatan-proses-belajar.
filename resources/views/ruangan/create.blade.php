...
<div class="card shadow-sm">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h1 class="h4 mb-0">Tambah Ruangan</h1>
        ...
        <form action="{{ route('ruangan.store') }}" method="POST">
            ...
            <div class="row g-3">
                <div class="col-md-8">
                    ...
                    <input class="form-control" id="nama_ruangan" name="nama_ruangan" value="{{ old('nama_ruangan') }}" required>
                </div>
                <div class="col-md-4">
                    <label class="form-label" for="kapasitas">Kapasitas</label>
                    <input class="form-control" type="number" min="1" id="kapasitas" name="kapasitas" value="{{ old('kapasitas', 1) }}" required>
                </div>
            </div>
