        ...
        <form action="{{ route('nilai-perkuliahan.update', $nilaiPerkuliahan) }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-2">
                    ...
                    <input class="form-control" type="number" step="0.01" id="nilai_akhir_preview" value="{{ old('nilai_akhir', $nilaiPerkuliahan->nilai_akhir) }}" readonly disabled>
                    <input type="hidden" id="nilai_akhir" name="nilai_akhir" value="{{ old('nilai_akhir', $nilaiPerkuliahan->nilai_akhir) }}">
                </div>
                <div class="col-md-2">
                    <label class="form-label" for="nilai_huruf">Huruf <small class="text-info">(Fuzzy)</small></label>
                    <input class="form-control" id="nilai_huruf_preview" value="{{ old('nilai_huruf', $nilaiPerkuliahan->nilai_huruf) }}" readonly disabled>
                    <input type="hidden" id="nilai_huruf" name="nilai_huruf" value="{{ old('nilai_huruf', $nilaiPerkuliahan->nilai_huruf) }}">
                </div>
                <div class="col-md-8">
    ...
    for (const tL of labels) {
        for (const uL of labels) {
            for (const uaL of labels) {
                ...
                let outLabel;
                if (tL === 'Tinggi' || uL === 'Tinggi' || uaL === 'Tinggi') {
                    outLabel = 'Tinggi';
