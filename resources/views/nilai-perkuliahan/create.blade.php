        ...
        <form action="{{ route('nilai-perkuliahan.store') }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-2">
                    ...
                    <input class="form-control" type="number" min="0" max="100" step="0.01" id="nilai_akhir" name="nilai_akhir" value="{{ old('nilai_akhir') }}">
                </div>
                <div class="col-md-2">
                    <label class="form-label" for="nilai_huruf">Huruf</label>
                    <input class="form-control" id="nilai_huruf" name="nilai_huruf" value="{{ old('nilai_huruf') }}" placeholder="A">
                </div>
                <div class="col-md-8">
